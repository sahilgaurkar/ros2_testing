...
public:
    ...
    void setupUi(QMainWindow *BaxterIO)
    {
        if (BaxterIO->objectName().isEmpty())
            BaxterIO->setObjectName(QString::fromUtf8("BaxterIO"));
        BaxterIO->resize(564, 440);
        BaxterIO->setStyleSheet(QString::fromUtf8("QWidget#centralWidget {\n"
...
"}"));
        ...
        right_arm_dial->setObjectName(QString::fromUtf8("right_arm_dial"));
        right_arm_dial->setGeometry(QRect(460, 160, 81, 81));
        right_arm_dial->setMaximum(255);
        left_arm_ok = new QPushButton(centralWidget);
        left_arm_ok->setObjectName(QString::fromUtf8("left_arm_ok"));
        left_arm_ok->setGeometry(QRect(50, 190, 31, 31));
        left_arm_ok->setStyleSheet(QString::fromUtf8(""));
        left_arm_show = new QPushButton(centralWidget);
        left_arm_show->setObjectName(QString::fromUtf8("left_arm_show"));
        left_arm_show->setGeometry(QRect(30, 240, 61, 51));
        left_arm_show->setStyleSheet(QString::fromUtf8(""));
        left_shoulder_ok = new QPushButton(centralWidget);
        left_shoulder_ok->setObjectName(QString::fromUtf8("left_shoulder_ok"));
        left_shoulder_ok->setGeometry(QRect(150, 190, 31, 31));
        left_shoulder_ok->setStyleSheet(QString::fromUtf8(""));
        right_shoulder_ok = new QPushButton(centralWidget);
        right_shoulder_ok->setObjectName(QString::fromUtf8("right_shoulder_ok"));
        right_shoulder_ok->setGeometry(QRect(390, 190, 31, 31));
        right_shoulder_ok->setStyleSheet(QString::fromUtf8(""));
        right_arm_ok = new QPushButton(centralWidget);
        right_arm_ok->setObjectName(QString::fromUtf8("right_arm_ok"));
        right_arm_ok->setGeometry(QRect(490, 190, 31, 31));
        right_arm_ok->setStyleSheet(QString::fromUtf8(""));
        left_shoulder_show = new QPushButton(centralWidget);
        left_shoulder_show->setObjectName(QString::fromUtf8("left_shoulder_show"));
        left_shoulder_show->setGeometry(QRect(130, 240, 61, 51));
        right_shoulder_show = new QPushButton(centralWidget);
        right_shoulder_show->setObjectName(QString::fromUtf8("right_shoulder_show"));
        right_shoulder_show->setGeometry(QRect(370, 240, 61, 51));
        right_shoulder_show->setStyleSheet(QString::fromUtf8(""));
        right_arm_show = new QPushButton(centralWidget);
        right_arm_show->setObjectName(QString::fromUtf8("right_arm_show"));
        right_arm_show->setGeometry(QRect(470, 240, 61, 51));
        right_arm_show->setStyleSheet(QString::fromUtf8(""));
        left_cuff_squeeze = new QPushButton(centralWidget);
        left_cuff_squeeze->setObjectName(QString::fromUtf8("left_cuff_squeeze"));
        left_cuff_squeeze->setGeometry(QRect(70, 320, 31, 51));
        left_cuff_squeeze->setStyleSheet(QString::fromUtf8(""));
        left_cuff_ok = new QPushButton(centralWidget);
        left_cuff_ok->setObjectName(QString::fromUtf8("left_cuff_ok"));
        left_cuff_ok->setGeometry(QRect(80, 370, 21, 21));
        left_cuff_ok->setStyleSheet(QString::fromUtf8(""));
        left_cuff_grasp = new QPushButton(centralWidget);
        left_cuff_grasp->setObjectName(QString::fromUtf8("left_cuff_grasp"));
        left_cuff_grasp->setGeometry(QRect(50, 370, 31, 21));
        left_cuff_grasp->setStyleSheet(QString::fromUtf8(""));
        left_cuff_grasp->setDefault(false);
        right_cuff_squeeze = new QPushButton(centralWidget);
        right_cuff_squeeze->setObjectName(QString::fromUtf8("right_cuff_squeeze"));
        right_cuff_squeeze->setGeometry(QRect(410, 320, 31, 51));
        right_cuff_squeeze->setStyleSheet(QString::fromUtf8(""));
        right_cuff_ok = new QPushButton(centralWidget);
        right_cuff_ok->setObjectName(QString::fromUtf8("right_cuff_ok"));
        right_cuff_ok->setGeometry(QRect(420, 370, 21, 21));
        right_cuff_ok->setStyleSheet(QString::fromUtf8(""));
        right_cuff_grasp = new QPushButton(centralWidget);
        right_cuff_grasp->setObjectName(QString::fromUtf8("right_cuff_grasp"));
        right_cuff_grasp->setGeometry(QRect(390, 370, 31, 21));
        right_cuff_grasp->setStyleSheet(QString::fromUtf8(""));
        left_arm_cancel = new QPushButton(centralWidget);
        left_arm_cancel->setObjectName(QString::fromUtf8("left_arm_cancel"));
        left_arm_cancel->setGeometry(QRect(30, 120, 61, 51));
        left_arm_cancel->setStyleSheet(QString::fromUtf8(""));
        left_shoulder_cancel = new QPushButton(centralWidget);
        left_shoulder_cancel->setObjectName(QString::fromUtf8("left_shoulder_cancel"));
        left_shoulder_cancel->setGeometry(QRect(130, 120, 61, 51));
        left_shoulder_cancel->setStyleSheet(QString::fromUtf8(""));
        right_shoulder_cancel = new QPushButton(centralWidget);
        right_shoulder_cancel->setObjectName(QString::fromUtf8("right_shoulder_cancel"));
        right_shoulder_cancel->setGeometry(QRect(370, 120, 61, 51));
        right_shoulder_cancel->setStyleSheet(QString::fromUtf8(""));
        right_arm_cancel = new QPushButton(centralWidget);
        right_arm_cancel->setObjectName(QString::fromUtf8("right_arm_cancel"));
        right_arm_cancel->setGeometry(QRect(470, 120, 61, 51));
        right_arm_cancel->setStyleSheet(QString::fromUtf8(""));
        logo = new QLabel(centralWidget);
        logo->setObjectName(QString::fromUtf8("logo"));
        logo->setGeometry(QRect(220, 150, 121, 121));
        logo->setStyleSheet(QString::fromUtf8("background-image: url(:/new/prefix/logo.png);\n"
...
"border: none;"));
        ...
        label_9->setStyleSheet(QString::fromUtf8("background-image: url(:/new/prefix/nav.png);\n"
"background-color: transparent;\n"
"background-repeat: none;\n"
"border: none;"));
        ...
        label_10->setStyleSheet(QString::fromUtf8("background-image: url(:/new/prefix/nav.png);\n"
"background-color: transparent;\n"
"background-repeat: none;\n"
"border: none;"));
        ...
        label_11->setStyleSheet(QString::fromUtf8("background-image: url(:/new/prefix/nav.png);\n"
"background-color: transparent;\n"
"background-repeat: none;\n"
"border: none;"));
        ...
        label_12->setStyleSheet(QString::fromUtf8("background-image: url(:/new/prefix/nav.png);\n"
"background-color: transparent;\n"
"background-repeat: none;\n"
"border: none;"));
        ...
        label->setStyleSheet(QString::fromUtf8("background-image: url(:/new/prefix/robot_arm.png);\n"
"background-color: transparent;\n"
"background-repeat: none;\n"
"border: none;"));
        ...
        label_2->setStyleSheet(QString::fromUtf8("background-image: url(:/new/prefix/robot_arm.png);\n"
"background-color: transparent;\n"
"background-repeat: none;\n"
"border: none;"));
...
"border: none;"));
    ...
    {
        BaxterIO->setWindowTitle(QApplication::translate("BaxterIO", "BaxterIO", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_WHATSTHIS
        BaxterIO->setWhatsThis(QApplication::translate("BaxterIO", "<html><head/><body><p>jghjhkhk</p></body></html>", 0, QApplication::UnicodeUTF8));
