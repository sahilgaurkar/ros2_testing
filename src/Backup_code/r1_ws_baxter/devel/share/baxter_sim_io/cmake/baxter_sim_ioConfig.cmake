...
if("TRUE" STREQUAL "TRUE")
  set(baxter_sim_io_SOURCE_PREFIX /ws_baxter/src/baxter_simulator/baxter_sim_io)
  set(baxter_sim_io_DEVEL_PREFIX /ws_baxter/devel)
  ...
  set(baxter_sim_io_INSTALL_PREFIX /ws_baxter/install)
...
if(NOT "/ws_baxter/src/baxter_simulator/baxter_sim_io/include " STREQUAL " ")
  set(baxter_sim_io_INCLUDE_DIRS "")
  set(_include_dirs "/ws_baxter/src/baxter_simulator/baxter_sim_io/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baxter_sim_io' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/ws_baxter/src/baxter_simulator/baxter_sim_io/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(baxter_sim_io_EXPORTED_TARGETS ${${baxter_sim_io_dep}_EXPORTED_TARGETS})
endforeach()
