...
if("TRUE" STREQUAL "TRUE")
  set(rethink_ee_description_SOURCE_PREFIX /ws_baxter/src/baxter_common/rethink_ee_description)
  set(rethink_ee_description_DEVEL_PREFIX /ws_baxter/devel)
  ...
  set(rethink_ee_description_INSTALL_PREFIX /ws_baxter/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rethink_ee_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/ws_baxter/src/baxter_common/rethink_ee_description/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(rethink_ee_description_EXPORTED_TARGETS ${${rethink_ee_description_dep}_EXPORTED_TARGETS})
endforeach()
