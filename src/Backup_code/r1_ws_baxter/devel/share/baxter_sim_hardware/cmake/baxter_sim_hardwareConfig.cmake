...
if("TRUE" STREQUAL "TRUE")
  set(baxter_sim_hardware_SOURCE_PREFIX /ws_baxter/src/baxter_simulator/baxter_sim_hardware)
  set(baxter_sim_hardware_DEVEL_PREFIX /ws_baxter/devel)
  ...
  set(baxter_sim_hardware_INSTALL_PREFIX /ws_baxter/install)
...
if(NOT "/ws_baxter/src/baxter_simulator/baxter_sim_hardware/include;/usr/include/opencv4 " STREQUAL " ")
  set(baxter_sim_hardware_INCLUDE_DIRS "")
  set(_include_dirs "/ws_baxter/src/baxter_simulator/baxter_sim_hardware/include;/usr/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baxter_sim_hardware' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/ws_baxter/src/baxter_simulator/baxter_sim_hardware/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /ws_baxter/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(baxter_sim_hardware_EXPORTED_TARGETS ${${baxter_sim_hardware_dep}_EXPORTED_TARGETS})
endforeach()
