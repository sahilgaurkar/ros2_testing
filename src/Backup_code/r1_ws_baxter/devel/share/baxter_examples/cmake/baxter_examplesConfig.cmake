...
if("TRUE" STREQUAL "TRUE")
  set(baxter_examples_SOURCE_PREFIX /ws_baxter/src/baxter_examples)
  set(baxter_examples_DEVEL_PREFIX /ws_baxter/devel)
  ...
  set(baxter_examples_INSTALL_PREFIX /ws_baxter/install)
...
if(NOT "/ws_baxter/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baxter_examples' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/ws_baxter/src/baxter_examples/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(baxter_examples_EXPORTED_TARGETS ${${baxter_examples_dep}_EXPORTED_TARGETS})
endforeach()
